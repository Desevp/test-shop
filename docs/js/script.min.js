...
var cart = function () {
  ...
  function _addToCart(idItem, count) {
    var id = idItem;
  ...
  function changeCart(elements) {
    ...
    elements.find('.js-counter-value').change(function () {
      ...
      updateCountProduct($(this).closest('.js-cart-product').data('id'), $(this).val());
  ...
  return {
    addToCart: function addToCart(idItem, itemCount) {
      _addToCart(idItem, itemCount);
    },
    init: function init() {
      _init();
    }
